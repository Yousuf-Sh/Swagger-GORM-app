...
func (o *PostLoginBody) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.Required("userLogin"+"."+"password", "body", o.Password); err != nil {
		return err
	}
...
func (o *PostLoginBody) validateUsername(formats strfmt.Registry) error {

	if err := validate.Required("userLogin"+"."+"username", "body", o.Username); err != nil {
		return err
	}
